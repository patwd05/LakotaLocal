...
function zoomToSchool() {
  ...
  map.on('load', () => {
    ...
    map.addLayer({
       ...
       // Add Parcel Tileset Source
       map.addSource('Lakota-tileset', {
        type: 'raster',
        url: 'mapbox://patwd05.1ihkrvr5',
        tileSize: 256
    });
    ...
    map.addLayer({
        id: 'Lakota-layer',
        type: 'raster',
        source: 'Lakota-tileset',
        paint: { 'raster-opacity': 1 }
    });
    
 // Add Parcel Tileset Source
 // ✅ Add Woodland Tileset Source
 map.addSource('Woodland-tileset', {
    type: 'raster',
    url: 'mapbox://patwd05.2y2y8cre',
    tileSize: 256
});
